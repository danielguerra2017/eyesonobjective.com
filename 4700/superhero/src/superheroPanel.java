...
public class superheroPanel extends JPanel
{
	...
	{		
		...
		northPanel.setLayout(new FlowLayout(FlowLayout.LEFT, 100, 5));
		...
		battleAgainButton.addActionListener(new ActionListener()
		{
			public void actionPerformed(ActionEvent event)
			{
				//********************************************************************
				// Need to figure out right here to make sequence repeat while using
				// same variables as last iteration
				// Variables to be used again as the same: yourChar, badName,diffNum
				// Make sure to reset health and badHealth
				//********************************************************************
			}
		});
